...
<div class="wrap tag-cloud-3d-admin">
    <h2><?php _e("3D Tag Cloud Options", "scriptcasetagcloud");?></h2>
    <?php
    if(isset($_POST['frm_submit'])):
        ...
        <div class="alert alert-success">
            <?php _e('Options saved.', 'scriptcasetagcloud' ); ?>
        </div>
    <?php endif;?>
    ...
    <form method="post" action="">
        <div class="panel panel-success">
            <div class="panel-heading">
                <label><?php _e('General Settings','scriptcasetagcloud');?></label>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">
                        <label><?php _e('Widget Title','scriptcasetagcloud');?></label>
                        <input class="form-control" type="text" name="frm_title" size="50" value="<?php echo $option_value['title'];?>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <label><?php _e('Number of tags','scriptcasetagcloud');?></label>
                        <input data-validation="number" class="form-control" type="text" name="frm_noof_tags" value="<?php echo $option_value['no_of_tags'];?>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <label><?php _e('Width','scriptcasetagcloud');?> (px - <?php _e('Enter only number', 'scriptcasetagcloud');?>)</label>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <label><?php _e('Height','scriptcasetagcloud');?> (px - <?php _e('Enter only number', 'scriptcasetagcloud');?>)</label>
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <label><?php _e('Color Settings (Hex value)','scriptcasetagcloud');?></label>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">
                        <label><?php _e('Background Color','scriptcasetagcloud');?> (# - <?php _e('Enter only alphanumeric', 'scriptcasetagcloud');?>)</label>
                        <input class="form-control" data-validation="alphanumeric" type="text" name="frm_bg_color"  value="<?php echo $option_value['bg_color'];?>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <label><?php _e('Text Color','scriptcasetagcloud');?> (# - <?php _e('Enter only alphanumeric', 'scriptcasetagcloud');?>)</label>
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <label><?php _e('Font Settings','scriptcasetagcloud');?></label>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">
                        <label><?php _e('Select the font','scriptcasetagcloud');?></label>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <label><?php _e('Maximum font size','scriptcasetagcloud');?> (px - <?php _e('Enter only number', 'scriptcasetagcloud');?>)</label>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <label><?php _e('Minimum font size','scriptcasetagcloud');?> (px - <?php _e('Enter only number', 'scriptcasetagcloud');?>)</label>
        ...
        <input class="btn btn-success" type="submit" name="frm_submit" value="<?php _e('Save','scriptcasetagcloud');?>"/>
    </form>
</div>
<?php
